...
mkdir w2.sub
python2 hyperwords/corpus2pairs.py --win 2 --sub 1e-5 ${CORPUS}.clean > w2.sub/pairs
scripts/pairs2counts.sh w2.sub/pairs > w2.sub/counts
python2 hyperwords/counts2vocab.py w2.sub/counts

# B) Window size 5 with dynamic contexts and "dirty" subsampling
mkdir w5.dyn.sub.del
python2 hyperwords/corpus2pairs.py --win 5 --dyn --sub 1e-5 --del ${CORPUS}.clean > w5.dyn.sub.del/pairs
scripts/pairs2counts.sh w5.dyn.sub.del/pairs > w5.dyn.sub.del/counts
python2 hyperwords/counts2vocab.py w5.dyn.sub.del/counts

# Calculate PMI matrices for each collection of pairs
python2 hyperwords/counts2pmi.py --cds 0.75 w2.sub/counts w2.sub/pmi
python2 hyperwords/counts2pmi.py --cds 0.75 w5.dyn.sub.del/counts w5.dyn.sub.del/pmi


# Create embeddings with SVD
python2 hyperwords/pmi2svd.py --dim 500 --neg 5 w2.sub/pmi w2.sub/svd
cp w2.sub/pmi.words.vocab w2.sub/svd.words.vocab
cp w2.sub/pmi.contexts.vocab w2.sub/svd.contexts.vocab
python2 hyperwords/pmi2svd.py --dim 500 --neg 5 w5.dyn.sub.del/pmi w5.dyn.sub.del/svd
...
python2 hyperwords/text2numpy.py w2.sub/sgns.words
rm w2.sub/sgns.words
python2 hyperwords/text2numpy.py w2.sub/sgns.contexts
...
python2 hyperwords/text2numpy.py w5.dyn.sub.del/sgns.words
rm w5.dyn.sub.del/sgns.words
python2 hyperwords/text2numpy.py w5.dyn.sub.del/sgns.contexts
...
python2 hyperwords/ws_eval.py --neg 5 PPMI w2.sub/pmi testsets/ws/ws353.txt
python2 hyperwords/ws_eval.py --eig 0.5 SVD w2.sub/svd testsets/ws/ws353.txt
python2 hyperwords/ws_eval.py --w+c SGNS w2.sub/sgns testsets/ws/ws353.txt

python2 hyperwords/ws_eval.py --neg 5 PPMI w5.dyn.sub.del/pmi testsets/ws/ws353.txt
python2 hyperwords/ws_eval.py --eig 0.5 SVD w5.dyn.sub.del/svd testsets/ws/ws353.txt
python2 hyperwords/ws_eval.py --w+c SGNS w5.dyn.sub.del/sgns testsets/ws/ws353.txt
...
python2 hyperwords/analogy_eval.py PPMI w2.sub/pmi testsets/analogy/google.txt
python2 hyperwords/analogy_eval.py --eig 0 SVD w2.sub/svd testsets/analogy/google.txt
python2 hyperwords/analogy_eval.py SGNS w2.sub/sgns testsets/analogy/google.txt

python2 hyperwords/analogy_eval.py PPMI w5.dyn.sub.del/pmi testsets/analogy/google.txt
python2 hyperwords/analogy_eval.py --eig 0 SVD w5.dyn.sub.del/svd testsets/analogy/google.txt
python2 hyperwords/analogy_eval.py SGNS w5.dyn.sub.del/sgns testsets/analogy/google.txt
